...
```bash
$ mvn archetype:generate -DartifactId=aws-lambda -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-jersey-archetype -DarchetypeVersion=2.1.2 -DgroupId=org.example -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd aws-lambda
$ sam build
